...
export const connectToDB = async () => {
  ...
  _db_scrooge_users = client.db("scrooge").collection("users");
  _db_affiliates = client.db("affiliates").collection("affiliates");
  _db_affiliates_successful_actions = client.db("affiliates").collection("successful-actions");
  _db_marketplace_chip_transactions = client.db("casino-nft-marketplace").collection("chip_transactions");
  _db_marketplace_coupons_merch = client.db("casino-nft-marketplace").collection("coupons_merch");
  _db_marketplace_daily_reward_token_claims = client.db("casino-nft-marketplace").collection("daily_reward_token_claims");
  _db_marketplace_ducky_lucks_chip_claims = client.db("casino-nft-marketplace").collection("ducky_lucks_chip_claims");
  _db_marketplace_ducky_lucks_prizes = client.db("casino-nft-marketplace").collection("ducky_lucks_prizes");
  _db_marketplace_holder_claim_chips_transactions = client.db("casino-nft-marketplace").collection("holder_claim_chips_transactions");
  _db_marketplace_items = client.db("casino-nft-marketplace").collection("items");
  _db_marketplace_prizes = client.db("casino-nft-marketplace").collection("prizes");
  _db_marketplace_redeem_prize_transactions = client.db("casino-nft-marketplace").collection("redeem_prize_transactions");
  ...
  _db_raffles = client.db("raffles").collection("raffles");
  _db_raffles_draws = client.db("raffles").collection("raffles_draws");
  _db_raffles_entries = client.db("raffles").collection("raffles_entries");
  _db_raffles_users = client.db("raffles").collection("raffles_users");
  _db_raffles_purchases = client.db("raffles").collection("raffles_purchases");
  //_db_sharing_hashtags = client.db("sharing-data").collection("hashtags");
  _db_sharing_messages = client.db("sharing-data").collection("messages");
