...
let _db_affiliates,_db_scrooge_data, _db_affiliates_successful_actions,_db_scrooge_social_share, _db_marketplace_chip_transactions, _db_marketplace_coupons_merch, _db_marketplace_daily_reward_token_claims, _db_marketplace_ducky_lucks_chip_claims, _db_marketplace_ducky_lucks_prizes,
...
export const connectToDB = async () => {
  ...
  console.log("client",client.db(process.env.SCROOGE_DB).collection("users"));
  ...
  _db_marketplace_coupons_merch = client.db(process.env.CASINO_NFT_MARKETPLACE_DB).collection("coupons_merch");
  _db_marketplace_daily_reward_token_claims = client.db(process.env.CASINO_NFT_MARKETPLACE_DB).collection("daily_reward_token_claims");
  _db_marketplace_ducky_lucks_chip_claims = client.db(process.env.CASINO_NFT_MARKETPLACE_DB).collection("ducky_lucks_chip_claims");
  _db_marketplace_ducky_lucks_prizes = client.db(process.env.CASINO_NFT_MARKETPLACE_DB).collection("ducky_lucks_prizes");
  _db_marketplace_holder_claim_chips_transactions = client.db(process.env.CASINO_NFT_MARKETPLACE_DB).collection("holder_claim_chips_transactions");
  _db_marketplace_items = client.db(process.env.CASINO_NFT_MARKETPLACE_DB).collection("items");
  _db_marketplace_prizes = client.db(process.env.CASINO_NFT_MARKETPLACE_DB).collection("prizes");
  _db_marketplace_redeem_prize_transactions = client.db(process.env.CASINO_NFT_MARKETPLACE_DB).collection("redeem_prize_transactions");
  ...
  _db_raffles_draws = client.db(process.env.RAFFLES_DB).collection("raffles_draws");
  _db_raffles_entries = client.db(process.env.RAFFLES_DB).collection("raffles_entries");
  _db_raffles_users = client.db(process.env.RAFFLES_DB).collection("raffles_users");
  _db_raffles_purchases = client.db(process.env.RAFFLES_DB).collection("raffles_purchases");
  //_db_sharing_hashtags = client.db("sharing-data").collection("hashtags");
  _db_sharing_messages = client.db(process.env.SHARING_DATA_DB).collection("messages");
...
export const get_marketplace_coupons_merchDB = () => _db_marketplace_coupons_merch;
export const get_marketplace_daily_reward_token_claimsDB = () => _db_marketplace_daily_reward_token_claims;
export const get_marketplace_ducky_lucks_chip_claimsDB = () => _db_marketplace_ducky_lucks_chip_claims;
export const get_marketplace_ducky_lucks_prizesDB = () => _db_marketplace_ducky_lucks_prizes;
export const get_marketplace_holder_claim_chips_transactionsDB = () => _db_marketplace_holder_claim_chips_transactions;
export const get_marketplace_itemsDB = () => _db_marketplace_items;
export const get_marketplace_prizesDB = () => _db_marketplace_prizes;
export const get_marketplace_redeem_prize_transactionsDB = () => _db_marketplace_redeem_prize_transactions;
